...
import "../../components/css/TermsAndConditions.css"; // Place the CSS below in this file or use a <style> tag
...
const TermsAndConditions = () => (
  ...
  <section className="terms-section">
    ...
    <div>
  <p><b>These terms apply to:</b></p>
  <ul>
    <li><b>Clients/Users:</b> Individuals seeking legal consultations.</li>
    <li><b>Lawyers/Advocates:</b> Legal professionals offering services.</li>
  </ul>
</div>
