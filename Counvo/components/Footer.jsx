  ...
  <footer style={footerStyles}>
    <div style={containerStyles}>
      ...
      <div style={sectionStyles}>
        ...
        <ul style={ulStyles}>
          <li>
            <a href="/terms" style={linkStyles}>Terms and Conditions</a>
          </li>
          <li>
            <a href="/privacy" style={linkStyles}>Privacy Policy</a>
               ...
               <li>
            <a href="shipping" style={linkStyles}>Shipping policy</a>
          </li>
             <li>
            <a href="/cancellation" style={linkStyles}>Cancellation Policy</a>
          </li>
               <li>
